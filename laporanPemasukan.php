    ...
    if (isset($_GET["tampilkanLaporan"])) {
        if (($_GET['filter_kategori'] != NULL) && ($_GET['filter_tgl_awal'] != NULL) && ($_GET['filter_tgl_akhir'] != NULL)) {
            ...
            $queryPemasukan = "
                                    ...
                                    AND pemasukan.id_kategori = '$idKategori' AND id_user = '$id'
                                ";
...
<body>
    ...
    <div class="container mt-4 border rounded-4 shadow">
        <div class="row">
            <div class="col">
                <form action="laporanPemasukan" method="GET">
                    <div class="m-3">
                ...
                <div class="m-3">
                    <form action="functions/exportExcel" method="POST">
                        ...
                        <input type="hidden" name="tipe_laporan" value="Pemasukan">
    ...
    <script type="text/javascript">
        <?php
            $query = "SELECT tanggal, SUM(jumlah) AS total_pemasukan FROM pemasukan
                        WHERE tanggal >= '$tglAwal' AND tanggal <= '$tglAkhir'
