<?php
    ...
    $pemasukan = query($queryPemasukan);
...
<body>
    ...
    <div class="container mt-4 border rounded-4 shadow">
        <div class="row">
            <div class="col">
                <div class="m-3">
                    <form action="kelolaPemasukan" method="GET">
                ...
                <div class="m-3">
                    <form action="kelolaPemasukan" method="GET" id="search-form">
                    ...
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#modalEdit"
                                                ...
                                                data-jumlah="<?= $p['jumlah'] ?>" data-id-pemasukan="<?= $p['id_pemasukan'] ?>">
                                            Edit
                                        </button>
                            ...
                            <tr>
                                ...
                                <td> <?= str_replace(',', '.', number_format($totalPemasukan)); ?> </td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <div class="modal-content">
                ...
                <form action="functions/tambahData" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="tambahPemasukan" class="btn btn-primary">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="functions/editData" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                        <button type="submit" name="editPemasukan" class="btn btn-primary">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $('#modalEdit').on('show.bs.modal', function(e) {
            ...
            var idPemasukan = $(e.relatedTarget).data('id-pemasukan');
            ...
            $(e.currentTarget).find('input[name="id_pemasukan"]').val(idPemasukan);
        });
    </script>
</body>
</html>
